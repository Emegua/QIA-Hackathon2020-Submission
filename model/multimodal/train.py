...
def multimodal_base_model():
    ...
    t = t_input
    t = Dense(64, name="text_inter", activation='relu')(t)
    #t = Dropout(0.15)(t)
    #t = Dense(64, name="text_inter_3",kernel_regularizer=regularizers.l2(0.0001), activation='relu')(t)

    v_input = Input(shape=(64,))
    v = v_input
    v = Dense(64, name="video_inter", activation='relu')(v)
    v = Dropout(0.5)(v)
    v = Dense(64, name="video_inter_2", activation='relu')(v)



    s_input = Input(shape=(64,))
    s = s_input
    s = Dense(64, name="speech_inter", kernel_regularizer=regularizers.l1(0.0001), activation='relu')(s)
    s = Dropout(0.4)(s)
    s = Dense(64, name="speech_inter_2", kernel_regularizer=regularizers.l1_l2(l1=0.0001,l2=0.0001), activation='relu')(s)
    s = Dropout(0.1)(s)
    s = Dense(64, name="speech_inter_4", kernel_regularizer=regularizers.l1_l2(l1=0.0001,l2=0.0001), activation='relu')(s)
    ...
    model = Model(inputs=[t_input,v_input], outputs=output, name="multimodal_model")
