...
if __name__ == '__main__':
    ...
    if(select == "train"):
        seqPath = '../../dataset/qia2020/image_frame_train/'
        csvPath = '../../dataset/qia2020/train.csv'
        savePath = 'features/train/'
    elif(select == "val"):
        seqPath = '../../dataset/qia2020/image_frame_val/'
        csvPath = '../../dataset/qia2020/val.csv'
        savePath = 'features/val/'
    elif(select == "test"):
        seqPath = '../../dataset/qia2020/image_frame_test/'
        csvPath = '../../dataset/qia2020/test.csv'
        savePath = 'features/test/'
    else:
        print("Invalid Input")
