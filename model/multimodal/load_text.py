...
##Set root path
text_folder_path = "../../dataset/qia2020/"
...
def text_data(folder_path,type):
    ...
    if(type=='train'):
        ...
        feature_path = sorted(glob.glob(folder_path + 'test/' + '*.npz'))
    else:
    ...
    np.save('../../dataset/qia2020/text_'+type+'.npy',output)

    return output

text_data(text_folder_path,'test')
