...
if __name__ == "__main__":
    ...
    load_dir_ = '../dataset/qia2020/val/*.mp4'
    save_dir_ = "../dataset/qia2020/image_frame_val/"
    video_to_frame(load_dir_, save_dir_)
    load_dir_2 = '../dataset/qia2020/test/*.mp4'
    save_dir_2 = "../dataset/qia2020/image_frame_test/"
    video_to_frame(load_dir_2, save_dir_2)