...
if __name__ == "__main__":
    ...
    load_dir = '../dataset/qia2020/train/'
    save_dir = '../dataset/qia2020/text_train.npy'
    text_to_npy(load_dir, save_dir)
    load_dir = '../dataset/qia2020/val/'
    save_dir = '../dataset/qia2020/text_val.npy'
    text_to_npy(load_dir, save_dir)
    load_dir = '../dataset/qia2020/test/'
    save_dir = '../dataset/qia2020/text_test.npy'
    text_to_npy(load_dir, save_dir)